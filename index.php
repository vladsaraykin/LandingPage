            ...
            <div class="row">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="item-content">
                        <a href="#">
                            <div class="feature-logo"><img class="img-features" src="assets/img/attractive-layout.png">
                            </div>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="item-content">
                        <a href="#">
                            <div class="feature-logo"><img class="img-features" src="assets/img/easy-to-customize.png">
                            </div>
                            <span class="feature-title">Attractive Layout</span>
                            <span class="feature-text">Nunc cursus libero purus ac congue arcu cursus ut sed vitae pulvinar massaidporta nequetiam elerisque mi id faucibus iaculis vitae pulvinar.</span>
                        </a>
...
<div class="testimonials">
    <div class="container">
        ...
        <div class="testimonials-quote">
            <div class="testimonials-quote-slick">
